...
public class App 
{
    ...
    {
        String[] dna =  {"ATGCGACAGTGG","CAGTGCTCACTG","TTATGTAGGGGG","AGAAGGTTATTT","CCCCTACAGTGC","TCACTGCCCCTA", "ATGCGACAGTGC","CAGTGCTCACTG","TTATGTAGGGGG","AGAAGGTTATTT","CCCCTACAGTGC","TCACTGCCCCTA"};
